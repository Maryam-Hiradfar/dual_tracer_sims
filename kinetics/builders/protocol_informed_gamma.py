#kinetics.protocol_informed_gamma.py
import numpy as np
...
from .basis_gamma import build_gamma_library_for_two_tracers, build_gamma_library_for_two_specific_injection_time_points
