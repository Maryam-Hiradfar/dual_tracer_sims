# # main.py
## Code status unknown -- likely old and needs updating to be compatible with refactored code (06/12/2026) - Maryam Hiradfar
...
# FIG_DIR = " /Users/maryamhiradfar/Documents/GitHub/dual_tracer_sims/figures/PBR_scale_1_fdg_scale_1" # this seems like it gets overwritten somewhere
