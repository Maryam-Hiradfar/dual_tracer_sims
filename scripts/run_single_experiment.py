...
from sim.config import TwoTracerBasisConfig, GammaBasisConfig
...
def main() -> None:
    ...
    cfg = ExperimentConfig(
        ...
        gamma_library = TwoTracerBasisConfig(
            tracer_1_basis=GammaBasisConfig(n_t0=5, n_tau=5),
            tracer_2_basis=GammaBasisConfig(n_t0=5, n_tau=5),
        ),
